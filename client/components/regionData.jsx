    ...
    if (countryData) {
      ...
      return (
        <div className="col-4 d-flex flex-column region-data">
          ...
          <button onClick={(e) => this.props.handleMapViewChange(e, countryData.view)} className="btn country-title-btn"><i className="fas fa-map-marked-alt show-map-icon"></i><small>Show Map</small></button>
